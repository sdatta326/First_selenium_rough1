...
public class flipcart {
	...
	public static void checkboxClick(String testData,WebDriver driver)
	{
		//WebElement element=driver.findElement(By.xpath("//div[@title='"+testData+"']/div/div/label/input/following-sibling::div[1]"));
		
		//driver.findElement(By.xpath("//div[starts-with(@title,'"+testData+"')]/div/div/label/input/following-sibling::div[1]")).click();
		driver.findElement(By.xpath("//div[contains(@title,'"+testData+"')]/div/div/label/input/following-sibling::div[1]")).click();	
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		checkboxClick("English",driver);
		Thread.sleep(5000);
		checkboxClick("French",driver);
		Thread.sleep(5000);
		checkboxClick("4",driver);
